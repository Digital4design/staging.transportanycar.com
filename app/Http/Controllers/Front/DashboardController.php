...
//  return    $quote;
        $quoteData = [
            ...
            'image' => $quote->image  === 'http://localhost:8000/uploads/no_car_image.png' ? null : $quote->image,
            ...
            'image_1' => $quote->image_1  === 'http://localhost:8000/uploads/no_car_image.png' ? null : $quote->image_1,
