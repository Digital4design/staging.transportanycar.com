                            ...
                            <div class="card-header @if ($key == 0) active @endif"
                                ...
                                <div class="card_lft">
                                    <div class="d-flex flex-wrap align-items-center" style="gap:5px;">
                                        ...
                                        @php
                                            ...
                                            $highlightedStars = 0; // Initialize yellow stars
                                            switch ($key) {
                                                case 0:
                                                    $highlightedStars = 3; // Example: 3 stars highlighted for key 0
                                                    break;
                                                case 1:
                                                    $highlightedStars = 4;
                                                    break;
                                                ...
                                                case 5:
                                                    ...
                                                    break;
                                                default:
                                                    $highlightedStars = 0; // Default to 0 if $key is undefined or invalid
                                                    break;
                                            }
                                        @endphp
                                            ...
                                            <li>
                                                <svg width="20" height="20" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        ...
                                                        fill="{{ $i <= $highlightedStars ? '#FFA800' : '#ccc' }}" />
                                                </svg>
                                            </li>
                                        @endfor
                                ...
                                <div class="wd-quote-btn">
                                    ...
                                    @if ($quote->status == 'pending' && !$hasAcceptedQuote)
                                        <a href="javascript:;" onclick="quoteChangeStatus({{ $quote->id }}, 'accept');"
                                        ...
                                        <a href="javascript:;" data-toggle="modal"
                                            data-target="#delete_quote_{{ $quote->id }}" class="d-lg-block">
