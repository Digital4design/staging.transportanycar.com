        ...
        <div class="row align-items-center align-items-md-end header-part">
            <div class="col-12 col-md-6">
                <div class="wd-quote-title">
                    ...
                    <p>You have received {{ count($quotes) }} quotes so far, choose the best one based on price and
        ...
        <div class="wd-quote-data">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center mobile-wrap first-mobile-wrap"
                                            ...
                                            <a href="{{ route('front.feedback_view', $quote->id) }}">
                                                <h4 style="line-height: 24px;">
                                                    ...
                                                    ({{ $quote->getTransporters->completed_job ?? '' }})
                                                </h4>
                                            </a>
                                        </div>
                                            ...
                                            <span class="verified-icon">
                                                ...
                                                <div class="icon_hover_sec">
                                                    <a class="hover_anchor">
                                                        <img src="{{ asset('assets/web/images/question.png') }}"
                                                            alt="question" />
                                                    </a>
                                    ...
                                    <div class="wd-quote-btn" style="width: 350px;">
                                        ...
                                        @if ($quote->status == 'pending' && !$hasAcceptedQuote)
                                            ...
                                            <a href="javascript:;" data-toggle="modal"
                                                data-target="#delete_quote_{{ $quote->id }}"
                                        ...
                                        @elseif($quote->status == 'accept')
                                            @if ($job_status != 'completed')
                                                <a href="{{ route('front.booking_confirm_page', $user_quote_id) }}"
                                                    class="wd-accepted-btn">Go
                                                    to booking</a>
                                            @else
                                                <a href="{{ route('front.user_deposit', ['id' => $quote->id]) }}"
                                                    class="wd-accepted-btn">Go
                                                    to booking</a>
                                            @endif
                                        @endif
            ...
            @else
                <div class="wd-quote-txt" style="border-bottom:1px solid #CFCFCF; border-radius: 10px;">
                    ...
                    <img src="{{ asset('assets/web/images/clock.png') }}" alt="" width="75"
