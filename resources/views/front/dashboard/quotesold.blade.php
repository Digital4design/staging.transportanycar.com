...
.card_lft .rating-star li:last-child span {font-size: 14px;}
...
@section('content')
    ...
    <section class="wd-quote-area bradius_10">
        ...
        <div class="wd-quote-data">
            <div class="wd-quote-table-head ss">
                    ...
                    <div class="card">
                        <div class="card-header @if($key == 0) active @endif" id="heading{{$key}}">
                            <div class="card_lft" style="width:calc(100% - 400px);">
                                <div class="d-flex flex-wrap align-items-center" style="gap:5px; max-width:20%; flex: 0 0 20%; justify-content:center">
                                    <a href="{{ route('front.feedback_view', $quote->id)}}">
                                        <h4 style="width: 100%; line-height: 24px;">{{$quote->getTransporters->username ??""}}</h4>
                                    </a>
                                
                                </div>
                                <div style="max-width:20%; flex: 0 0 20%; text-align:center;">
                                    ...
                                    @php
                                        $totalStars = 5;
                                        $yellowStars = round($quote->rating_average); 
                                    @endphp
                                    <ul class="rating-star choose_quote_rating justify-content-center">
                                ...
                                <div class="icon_hover_sec d-flex align-item-center justify-content-center" style="max-width:20%; flex: 0 0 20%;">
                                ...
                                <h5 style="max-width:20%; flex: 0 0 20%; text-align:center;">£{{$quote->price}}</h5>
                            </div>
