                        ...
                        <div class="foot_img row mx-0 align-items-center justify-content-between justify-content-md-center justify-content-md-end">
                            ...
                            <ul class="list-inline social-icons ml-3">
                                <li>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="25px" height="25px" fill="#ffffff" class="mx-auto d-block" id="fb-url" style="cursor: pointer">    
...
<script>
  document.getElementById('fb-url').addEventListener('click', function() {
    const fbUrl = "https://www.facebook.com/share/16A3vJKiYH/?mibextid=wwXIfr";
