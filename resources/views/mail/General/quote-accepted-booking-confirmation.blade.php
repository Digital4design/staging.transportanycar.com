...
<div class="contain" style="text-align: center;">
    <img src="https://mcusercontent.com/8992880337eb54b5df095f667/images/91d6d431-803b-d338-b1ae-4ab578715e2c.jpg"
        ...
        alt="transport notifiaction" title="transport notifiaction"></a>
    <h2>Hi,</h2>
    <p class="adjust-space">You have accepted {{ $data['transporter_info']-> }} quote of £{{ $data['quotation']->price }}</strong> to deliver your {{ $data['quotation']->quote->vehicle_make}} {{$data['quotation']->quote->vehicle_model}} @if (!empty($data['quotation']->quote->vehicle_make_1) && !empty($data['quotation']->quote->vehicle_model_1))
