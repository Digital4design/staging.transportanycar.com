                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    <div style="max-width: 600px;"><img src="https://image.optimite.email/wp-content/uploads/2024/02/Email-8-12-02-24-copy.png" style="display: block; height: auto; border: 0; width: 100%;" width="600" alt="Thank you for your application" title="Thank you for your application"></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:15px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0;">Our team are currently reviewing your information and you will receive an approval update shortly.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
