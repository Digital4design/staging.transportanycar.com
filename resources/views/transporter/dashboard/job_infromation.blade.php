                            ...
                            <div
                                ...
                                <div class="car-content">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center position-relative pl-3">
                                        <svg class="position-absolute" style="left:0; top:0;" width="10" height="16" viewBox="0 0 16 22" fill="none"
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if ( $transporter->user_quote_id == null)
                                                    <form id="chat__form_{{ $key }}"
                                                        ...
                                                        <div class="message-error error" style="display:none">Please enter your message.</div>
