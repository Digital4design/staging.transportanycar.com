...
@if (isset($user) && !empty($user))
            ...
            <div>
                ...
                <ul>
                    <li>
                        ...
                        <span class="ml-1">{{$quote->pickup_postcode ? hidePostcode(get_last_two_parts($quote->pickup_postcode)) : null}}</span>
                    </li>
                    <li>
                        <svg width="10" height="16" viewBox="0 0 16 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="chat_conversation_footer">
        ...
        <p class="chat-note text-left font-weight-normal position-relative" style="font-size:12px; padding-left:40px;">
            ...
            Do not share your contact details or personal information here.            {{-- Note: Users are required to accept your quote online via this platform and then we will exchange your
