            ...
            <div>
                ...
                <ul>
                    <li>
                        ...
                        <span class="ml-1">{{$quote->pickup_postcode ? get_last_two_parts($quote->pickup_postcode) : null}}</span>
                    </li>
                    <li>
                        <svg width="10" height="16" viewBox="0 0 16 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="ml-1">{{$quote->drop_postcode ? get_last_two_parts($quote->drop_postcode) : null}}</span>
                    </li>
                </ul>
                {{-- <p>
