                            ...
                            <ul>
                                <li>
                                    ...
                                    <input type="checkbox" id="summary_of_leads" name="summary_of_leads" value="1"
                                        <?php echo e($data->summary_of_leads == 1 ? 'checked' : ''); ?> style="opacity: 0; z-index: -1;">
                                ...
                                <li>
                                    ...
                                    <input type="checkbox" id="outbid_email_unsubscribe" name="outbid_email_unsubscribe"
                                        value="1" <?php echo e($data->outbid_email_unsubscribe == 1 ? 'checked' : ''); ?> style="opacity: 0; z-index: -1;">
                                ...
                                <li>
                                    ...
                                    <input type="checkbox" id="saved_search_alerts" name="saved_search_alerts"
                                        value="1" <?php echo e($data->job_email_preference == 1 ? 'checked' : ''); ?> style="opacity: 0; z-index: -1;">
                                ...
                                <li>
                                    ...
                                    <input type="checkbox" id="new_job_alert" name="new_job_alert"
                                        value="1" <?php echo e($data->new_job_alert == 1 ? 'checked' : ''); ?> style="opacity: 0; z-index: -1;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[type="checkbox"]').change(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('transporter.updateManageNotification')); ?>",
                    method: "POST",
                    data: {
...
<?php echo $__env->make('layouts.transporter.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/public_html/resources/views/transporter/dashboard/notifications/manageNotification.blade.php ENDPATH**/ ?>