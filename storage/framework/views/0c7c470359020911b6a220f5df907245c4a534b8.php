    ...
    <main>
        <section class="join_network_main trans_login_main position-relative">
            <div class="container">
                ...
                <form class="trans_login_blog" action="<?php echo e(route('transporter.login_post')); ?>" name="form_login" id="form_login" method="post" autocomplete="off">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <a href="<?php echo e(route('transporter.forgot_password')); ?>" class="manual_link d-inline-block">Forgot password</a>
                                </div>
                            </div>
                        </div>
                        <div class="btngroup">
...
<?php echo $__env->make('layouts.transporter.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/guest/login.blade.php ENDPATH**/ ?>