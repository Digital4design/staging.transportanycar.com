...
<script type="text/javascript">
    $(document).ready(function() {
        oTable = $('#listResults').DataTable({
            ...
            "ajax": "<?php echo e(route('admin.user.listing')); ?>",
            "columns": [{
                    "data": "id",
                    searchable: false,
                    sortable: false
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/public_html/resources/views/admin/user/index.blade.php ENDPATH**/ ?>