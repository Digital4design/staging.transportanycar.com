    ...
    <div class="container">
        <div class="row">
                ...
                <ul class="ftmenu_list">
                    ...
                    <li>
                        <?php if(Auth::guard('transporter')->user()): ?>
                            <a href="<?php echo e(route('transporter.dashboard')); ?>">
                                Account</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('transporter.login')); ?>">Account</a>
                        <?php endif; ?>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-12 btm_footer text-center mt-3">
                <p class="mb-0">Transport Any Car. <span>© All rights reserved. <?php echo e(date('Y')); ?></span></p>
                <div class="foot_img">
...
<?php /**PATH /var/www/html/public_html/resources/views/layouts/web/transporter_footer.blade.php ENDPATH**/ ?>