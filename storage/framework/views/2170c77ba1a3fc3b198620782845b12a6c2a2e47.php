    ...
    <div class="job-data">
        ...
        <?php else: ?>
            <?php if($quotes->total() > 50): ?>
                <span>Results: <?php echo e($quotes->firstItem()); ?>-<?php echo e($quotes->lastItem()); ?> of <?php echo e($quotes->total()); ?></span>
            <?php else: ?>
...
?>
        <div class="deshbord-job-listing job_list_desh_mobile" id="edit_bid_<?php echo e($quote->id); ?>">
            <?php if($type != 'cancel'): ?>
            ...
            <?php else: ?>
                <div class="bidding_new_design_date job_new_grid_date">
                    ...
                    <span>
                        <?php echo e(formatCustomDate($quote->qbt_updated_at)); ?>
            ...
            <li>
                    ...
                    <div class="list_img">
                        <img src="<?php echo e($quote->image); ?>">

                        <?php if($transporterQuotesCount > 0): ?>
                        
                        <p class="">£<?php echo e(new_roundBasedOnDecimal($quote->transporter_payment) ?? 'N/A'); ?></p>
                        <?php endif; ?>

                        <span>Posted <?php echo e(getTimeAgo($quote->created_at->toDateTimeString())); ?></span>
                    </div>
                ...
                <div class="list_detail">
                    ...
                    <p><b>
                        <?php if($type == 'bidding'): ?>
                        <?php echo e($quote->pickup_postcode ? hidePostcode(get_last_two_parts($quote->pickup_postcode)) : '-'); ?>

                        <?php else: ?>
                        <?php echo e($quote->pickup_postcode ? hidePostcode($quote->pickup_postcode) : '-'); ?>
                ...
                <div class="list_detail">
                    ...
                    <p><b>
                        ...
                        <?php if($type == 'bidding'): ?>
                        <?php echo e($quote->drop_postcode ? hidePostcode(get_last_two_parts($quote->drop_postcode)) : '-'); ?>

                        <?php else: ?>
                        <?php echo e($quote->drop_postcode ? hidePostcode($quote->drop_postcode) : '-'); ?>
                ...
                <div class="list_detail">
                    ...
                    <p>Make & model:</p>
                    <p><b><?php echo e($quote->vehicle_make); ?> <?php echo e($quote->vehicle_model); ?></b></p>
                </div>
                <div class="list_detail">
                    <span>
                        <img src="<?php echo e(asset('assets/web/images/dashboard/calendar.svg')); ?>" alt="calendar Icon">
                    </span>
                    <p>Delivery date:</p>
                    <p>
                        <?php if($quote->delivery_timeframe_from): ?>
                            <b><?php echo e(date('d/m/Y', strtotime($quote->delivery_timeframe_from))); ?></b>
                        <?php else: ?>
                            <b><?php echo e($quote->delivery_timeframe); ?></b>
                        <?php endif; ?>
                    </p>
                </div>
               
                <?php if($type == 'all'): ?>
                    <?php if($quote->status == 'completed' && $quote->qbt_status != 'pending'): ?>
                        <div class="won_details">
                            <a href="<?php echo e(route('transporter.current_jobs', ['id' => $quote->quote_by_transporter_id])); ?>"
                    ...
                    <?php endif; ?>
                    <?php if($quote->qbt_status == 'pending'): ?>
                        <div class="won_details">
                            <a href="<?php echo e(route('transporter.job_information', $quote->id)); ?>"
                                data-amount="<?php echo e(roundBasedOnDecimal($quote->transporter_payment)); ?>"
                                data-lowbid="<?php echo e($lowestBid); ?>" data-bidcount="<?php echo e($transporterQuotesCount); ?>"
                                class="view_btn edit_quote_btn won_details checkstatus">Edit bid</a>
                        </div>
                        <div class="won_message">
                            <a href="<?php echo e(route('transporter.messages', ['thread_id' => $quote->thread_id])); ?>"
                                class="view_btn edit_quote_btn">Message</a>
                        </div>
                        <a href="javascript:;" data-toggle="modal" data-target="#delete_quote_<?php echo e($quote->id); ?>"
                    ...
                    <?php endif; ?>
                <?php elseif($type == 'won'): ?>
                    <?php if($quote->status == 'ongoing' ||$quote->status == 'completed'): ?>
                        <div class="won_details">
                            <a href="<?php echo e(route('transporter.current_jobs', ['id' => $quote->quote_by_transporter_id])); ?>"
                                class="view_btn"> View details </a>
                        </div>
                ...
                <?php elseif($type == 'cancel'): ?>
                        <div class="list_detail" style="order:2;">
                            <a style="width: 130px;text-align: center;justify-content: center;" href="<?php echo e(route('transporter.job_information', $quote->id)); ?>"
                                data-amount="<?php echo e(roundBasedOnDecimal($quote->transporter_payment)); ?>"
                                data-lowbid="<?php echo e($lowestBid); ?>" data-bidcount="<?php echo e($transporterQuotesCount); ?>"
                                class="view_btn edit_quote_btn won_details checkstatus">Edit bid</a>
                        </div>
            ...
            <div class="bidding_new_design">
                ...
                <div class="bidding_new_design_grid job_new_grid_miles">
                    ...
                    <span class="sub_color"><?php echo e(str_replace(' mi', '', $quote->distance)); ?>

                        <span>(<?php echo e($quote->duration); ?>)</span></span>
                </div>
        ...
        <!-- delete quote Modal -->
        <div class="modal fade mark_bx" id="delete_quote_<?php echo e($quote->id); ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer p-0">
                        ...
                        <a href="javascript:void(0)" onclick="quoteChangeStatus(<?php echo e($quote->id); ?>, 'rejected');"
                            class="yes_btn">Yes</a>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/dashboard/partial/current_my_job.blade.php ENDPATH**/ ?>