...
<?php if(isset($user) && !empty($user)): ?>
    <div class="chat_conversation_header user_header">
        <div class="chat_head_lft">
            ...
            <div class="conversation_user d-flex flex-wrap align-items-center">
               ...
               <?php if($transporter->profile_image == env('APP_URL')): ?>
                    ...
                    <img src="<?php echo e($transporter->profile_image); ?>" alt="" width="58" height="58"
                    style="max-width: 100%;" />
                </div>
                 <?php endif; ?> 
                ...
                <div>
                    ...
                    <h3 class="mb-1 text-left">
                        <?php echo e($transporter_username); ?>

                        <img
                            src="<?php echo e(asset('assets/images/user-verified.png')); ?>" alt="" width="20"
        ...
        <?php if($thread->user_qot->status == 'pending' || $thread->user_qot->status == 'approved'): ?>
            <a href="javascript:;" onclick="quoteChangeStatus(<?php echo e($quote_by_transporter_id); ?>);"
                class="chat_accept_btn">Accept quote</a>
        <?php elseif($thread->user_qot->status == 'ongoing'): ?>
            <a href="<?php echo e(route('front.booking_confirm_page', $thread->user_qot->id)); ?>" class="chat_accept_btn">Go to
                booking</a>
        <?php elseif($thread->user_qot->status == 'completed'): ?>
            <a href="<?php echo e(route('front.user_deposit', $thread->user_qot->id)); ?>" class="chat_accept_btn">Go to booking</a>
        <?php endif; ?>
    </div>
    ...
    <div class="chat_conversation_body scrollbar chat_div" id="style-1">
        <?php if(isset($messages) && $messages->count() > 0): ?>
                        ...
                        <div class="chat_messages_incoming mb-0">
                            <div class="chat_conversation_bx">
                                <div class="chat_txt_bx">
                                    <?php if($previousSender !== $message->sender_id): ?>
                                        <h4><?php echo e($transporter_username); ?></h4> <!-- Sender name only displayed once -->
                                    <?php endif; ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <input type="hidden" id="last_message_sender" value="<?php echo e($previousSender); ?>">
        <?php endif; ?>
    </div>
    ...
    <div class="chat_conversation_footer">
        ...
        <form id="chat__form" action="<?php echo e(route('front.message.store', $thread->user_quote_id)); ?>" method="post"
...
<?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/front/dashboard/partial/history_listing.blade.php ENDPATH**/ ?>