...
<body style="margin: 0;font-weight: 300;font-family: 'Outfit', sans-serif;font-size: 16px;line-height: 22px; background-color: #ffffff; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<div style="text-align: center; max-width: 600px;width: 100%;margin: auto;padding: 0;box-sizing: border-box;">
		...
		<p style="margin-top: 25px; margin-bottom: 25px; font-weight: 300; font-family: 'Outfit', sans-serif; font-size: 16px; line-height: 22px;">
			Reset your password to your account <?php if($data['page_type'] == 'admin'): ?>
			<a href="<?php echo e(route('front.forgot_password_view', $data['reset_token'])); ?>" target="_blank" >here</a>
			<?php elseif($data['page_type'] == 'user'): ?>
			<a href="<?php echo e(route('front.web_password_upadte', $data['reset_token'])); ?>" target="_blank" >here</a>
			<?php elseif($data['page_type'] == 'transporter'): ?>
			<a href="<?php echo e(route('transporter.trans_password_upadte', $data['reset_token'])); ?>" target="_blank" >here</a>
			<?php endif; ?>
		</p>
		<p style="margin-top: 25px; margin-bottom: 25px; font-weight: 300; font-family: 'Outfit', sans-serif; font-size: 16px; line-height: 22px;">
			The link will expire in 24 hours. If it expires you must generate a new email and link  <a href="<?php echo e(route('transporter.forgot_password')); ?>">here.</a>
		</p>
...
</html><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/mail/General/reset_account_password.blade.php ENDPATH**/ ?>