...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="admin_job_bx find_trans_newjob list_of_items" id="style-1">
                        ...
                        <section class="transportSection container">
                            ...
                            <div class="mainContentDiv">
                                <div class="job-data">
                                    <?php if($quotes->total() == 0): ?>
                                        <span>Results: 0</span>
                                    <?php else: ?>
                                        <?php if($quotes->total() > 50): ?>
                                            <span>Results: <?php echo e($quotes->firstItem()); ?>-<?php echo e($quotes->lastItem()); ?> of
                                                <?php echo e($quotes->total()); ?></span>
                                        <?php else: ?>
                                            <?php if($quotes->firstItem() == $quotes->lastItem()): ?>
                                                <span>Results: <?php echo e($quotes->firstItem()); ?> of <?php echo e($quotes->total()); ?></span>
                                            <?php else: ?>
                                                <span>Results: <?php echo e($quotes->firstItem()); ?>-<?php echo e($quotes->lastItem()); ?> of
                                                    <?php echo e($quotes->total()); ?></span>
                                            <?php endif; ?>
                                    ...
                                    <?php $__currentLoopData = $quotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="boxContent addEventListener">
                                            <div class="boxContentList">
                                                ...
                                                <h2 class="imgHeading">
                                                    <span>Posted
                                                        <?php echo e(getTimeAgo($quote->created_at->toDateTimeString())); ?></span>
                                                </h2>
                                                <div class="boxImg-text car-row" data-car-id="<?php echo e($quote->id); ?>">
                                                    <div class="imgCol">
                                                        <img src="<?php echo e($quote->image); ?>" class="" alt="image" />
                                                    </div>
                                                    <div class="textCol">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <span
                                                                    class="text-decoration-none"><?php echo e($quote->pickup_postcode ? hidePostcode(get_last_two_parts($quote->pickup_postcode)) : '-'); ?></span>
                                                            </li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <span
                                                                    class="text-decoration-none"><?php echo e($quote->drop_postcode ? hidePostcode(get_last_two_parts($quote->drop_postcode)) : '-'); ?></span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="contentBlockBtn">
                                                    <div class="leftList">
                                                        <ul class="col-6 px-0 car-row "
                                                            data-car-id="<?php echo e($quote->id); ?>">
                                                            <li>
                                                                <b>Expiry date:</b>
                                                                <span class="font-weight-light">
                                                                    <?php echo e(formatCustomDate($quote->created_at->addDays(10))); ?>
                                                            ...
                                                            <li class="colorDivBlue">
                                                                ...
                                                                <?php if($quote->delivery_timeframe_from): ?>
                                                                    <span
                                                                        class="sub_color"><?php echo e(formatCustomDate($quote->delivery_timeframe_from)); ?></span>
                                                                <?php else: ?>
                                                                    <span
                                                                        class="sub_color"><?php echo e($quote->delivery_timeframe); ?></span>
                                                                <?php endif; ?>
                                                            </li>

                                                            <li class="colorDivBlue">
                                                                <b>Delivery type:</b>
                                                                <span class="sub_color"> <?php echo e($quote->how_moved); ?></span>
                                                            </li>
                                                            <li class="colorDivBlue">
                                                                <b>Journey miles:</b>
                                                                <span
                                                                    class="sub_color"><?php echo e(str_replace(' mi', '', $quote->distance)); ?></span>
                                                                <span class="grey">(<?php echo e($quote->duration); ?>)</span>
                                                            </li>
                                                        ...
                                                        <ul class="col-6 px-0">
                                                            ...
                                                            <?php if($transporterQuotesCount > 0): ?>
                                                                <li class="colorDivgreen car-row"
                                                                    ...
                                                                    <span class="sub_color">£<?php echo e($lowestBid); ?></span>
                                                                </li>
                                                            <?php else: ?>
                                                                <li class="colorDivgreen car-row"
                                                                    data-car-id="<?php echo e($quote->id); ?>">
                                                            ...
                                                            <li class="colorDivBlue  mb-2 car-row"
                                                                ...
                                                                <?php if($transporterQuotesCount > 0): ?>
                                                                    <span
                                                                        class="sub_color"><?php echo e($transporterQuotesCount); ?></span>
                                                                <?php else: ?>
                                                                    <span class="sub_color">0</span>
                                                                <?php endif; ?>
                                                            </li>
                                                            <li class="row mx-0 w-100 align-items-end mb-0">
                                                                <div class="btnCol">
                                                                    <?php if($quote->quoteByTransporter): ?>
                                                                        <a href="<?php echo e(route('transporter.job_information', $quote->id)); ?>"
                                                    ...
                                                    <?php else: ?>
                                                        <?php if($quote->created_at->timezone('Europe/London')->diffInHours(now('Europe/London')) < 1): ?>
                                                            <div class="actionDiv">
    ...
    <?php echo $__env->make('transporter.Modal.saveSearch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        var carDetails = <?php echo json_encode($quotes, 15, 512) ?>;
        ...
        $("#saveSrchForm").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('transporter.save.search')); ?>",
                type: "POST",
                data: {
                    pick_area: pick_area,
                    drop_area: drop_area,
        ...
        function share_give_quote(id) {
            $('#quote_id').val(id);
            var quotes = <?php echo json_encode($quotes, 15, 512) ?>;
        ...
        var jobInfoUrl = "<?php echo e(route('transporter.job_information', ':id')); ?>";
...
<?php echo $__env->make('layouts.transporter.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/dashboard/new_jobs_new.blade.php ENDPATH**/ ?>