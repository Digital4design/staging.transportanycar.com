...
<?php $__env->startSection('head_css'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/web/vendors/owl.carousel/css/owl.carousel.min.css')); ?>" />
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="wrapper">
        <!-- SIDEBAR -->
        <?php echo $__env->make('layouts.transporter.dashboard.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div id="page-content-wrapper">
            <?php echo $__env->make('layouts.transporter.dashboard.top_head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- content part -->
                    ...
                    <div class="admin-profile-box">
                        <div class="row">
                                ...
                                <div class="wd-admin-profile">
                                    <div class="admin-profile-top">
                                        <div class="admin-profile-area">
                                            <div class="edit-profile-photo">
                                                <img src="<?php if($user->profile_image): ?> <?php echo e(checkFileExist($user->profile_image)); ?> <?php endif; ?>"
                                            ...
                                            <div>
                                                ...
                                                <a href="<?php echo e(route('transporter.logout')); ?>" class="logout_txt desk_view">
                                    ...
                                    <div class="wd-profl-botm">
                                        <div class="wd-profl-lst">
                                            <p>Jobs completed</p>
                                            <span><?php echo e($jobs_completed_count); ?></span>
                                        </div>
                                        <div class="wd-profl-lst">
                                            <p>Total earnings</p>
                                            <span>£<?php echo e($total_earning_count); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-8 pl-xl-0">
                                <form action="<?php echo e(route('transporter.profile_post')); ?>" name="form_account" id="form_account"
                                    method="post" autocomplete="off" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="wd-profile-form pb-0 px-0">
                                        <input type="hidden" name="country_code" id="country_code"
                                            value="<?php echo e(empty($user->country_code) ? '+44' : $user->country_code); ?>">



                                        <?php if($user->is_status == '' || $user->is_status == 'pending' || $user->is_status == 'rejected'): ?>
                                            <?php if(
                                            ...
                                            <div class="row mx-0 mx-xl-4">
                                                <?php if(
                                                    ...
                                                    <div class="col-md-6 col-xl-6 requied_sec mb-0 upload_docs px-0 px-md-3 pl-lg-0 px-xl-3"
                                                        style="<?php echo e($user->is_status == 'approved' ? 'display:block' : ''); ?>">
                                                                ...
                                                                <div class="info_sec_details">
                                                                    <div class="info_sec_details_contant">
                                                                        <p>In order to be one of our transport providers you
                                                                            need
                                                                            the following documents. This is to protect not
                                                                            only
                                                                            you
                                                                            but the customer from damage or loss. If you’re
                                                                            unable
                                                                            to provide these documents unfortunately your
                                                                            application will not be considered. If you have
                                                                            any
                                                                            questions about the required documents please
                                                                            email
                                                                            us
                                                        ...
                                                        <div class="upload-section">
                                                            <?php if($user->driver_license == null): ?>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($user->goods_in_transit_insurance == null): ?>
                                                                <div class="requied_sec_row">
                                                                    <div class="form-group">
                                                                        <div class="document border-danger">
                                                ...
                                                <?php if($user->driver_license != null || $user->goods_in_transit_insurance != null): ?>
                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="document">
                                                                                <label for=""
                                                                                    ...
                                                                                    Valid driving license
                                                                                    <a class="view-pdf"
                                                                                        href="<?php echo e(url($user->driver_license)); ?>"
                                                                                        data-toggle="modal"
                                                                                        data-target="#pdfModal"
                                                                                        data-url="<?php echo e(url($user->driver_license)); ?>">View</a>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="document">
                                                                                <label for=""
                                                                                    ...
                                                                                    Goods in transit insurance
                                                                                    <a class="view-pdf"
                                                                                        href="<?php echo e(url($user->goods_in_transit_insurance)); ?>"
                                                                                        data-toggle="modal"
                                                                                        data-target="#pdfModal"
                                                                                        data-url="<?php echo e(url($user->goods_in_transit_insurance)); ?>"
                                                ...
                                                <div class="col-md-6 col-xl-6 requied_sec verify_email_sec px-0 px-md-3  mt-3 pt-2"
                                                    ...
                                                    <?php if($user->email_verify_status == '0'): ?>
                                        ...
                                        <div class="wd-admin-profile d-xl-none">
                                            <div class="admin-profile-top">
                                                <div class="admin-profile-area">
                                                    ...
                                                    <div>
                                                        <h2><?php echo e($user->name); ?></h2>
                                                        <a href="<?php echo e(route('transporter.logout')); ?>"
                                        ...
                                        <?php if($user->is_status == 'approved'): ?>
                                            <div class="row mx-4">
                                                <div class="col-md-6 col-xl-6 mb-0 pl-0 pl-xl-3 px-0 pr-md-3 mt-3 pt-2">
                                        ...
                                        <div class="row align-items-end mx-4">
                                            <div class="col-lg-6 pr-lg-3">
                                                <div class="form-group ">
                                                    <label for=""
                                                        class="mb-1 <?php echo e(empty($companyDetail) || empty($companyDetail->git_insurance_cover) ? 'text-danger' : ''); ?>">GIT
                                                        insurance cover</label>
                                                    <select
                                                        class="form-control <?php echo e(empty($companyDetail) || empty($companyDetail->git_insurance_cover) ? 'border-danger' : ''); ?>"
                                                        name="git_insurance_cover" id="git_insurance_cover"
                                                        onchange="updateBorderColor(this)">
                                                        <option value="" disabled
                                                            <?php echo e(old('git_insurance_cover', optional($companyDetail)->git_insurance_cover) == '' ? 'selected' : ''); ?>>
                                                            Select git insurance cover</option>
                                                        <?php $__currentLoopData = [10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e(number_format($amount)); ?>"
                                                                <?php echo e(old('git_insurance_cover', optional($companyDetail)->git_insurance_cover) == number_format($amount) ? 'selected' : ''); ?>>
                                                                £<?php echo e(number_format($amount)); ?>

                                                            </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="1,000,000+"
                                                            <?php echo e(old('git_insurance_cover', optional($companyDetail)->git_insurance_cover) == '1,000,000+' ? 'selected' : ''); ?>>
                                                            £1,000,000+</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for=""
                                                        class="mb-1 <?php echo e(empty($companyDetail) || empty($companyDetail->years_established) ? 'text-danger' : ''); ?>">Years
                                                        established</label>
                                                    <select
                                                        class="form-control <?php echo e(empty($companyDetail) || empty($companyDetail->years_established) ? 'border-danger' : ''); ?>"
                                                        name="years_established" id="years_established"
                                                        onchange="updateBorderColor(this)">
                                                        <option value="" disabled
                                                            <?php echo e(old('years_established', optional($companyDetail)->years_established) == '' ? 'selected' : ''); ?>>
                                                            Years established</option>
                                                        <?php $__currentLoopData = range(1, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($year); ?>"
                                                                <?php echo e(old('years_established', optional($companyDetail)->years_established) == (string) $year ? 'selected' : ''); ?>>
                                                                <?php echo e($year); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="10+"
                                                            <?php echo e(old('years_established', optional($companyDetail)->years_established) == '10+' ? 'selected' : ''); ?>>
                                                            10+</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 pl-lg-3">
                                                <div class="form-group">
                                                    <label for=""
                                                        class="mb-1 <?php echo e(empty($companyDetail) || empty($companyDetail->no_of_tow_trucks) ? 'text-danger' : ''); ?>">No
                                                        of tow trucks</label>
                                                    <select
                                                        class="form-control <?php echo e(empty($companyDetail) || empty($companyDetail->no_of_tow_trucks) ? 'border-danger' : ''); ?>"
                                                        name="no_of_tow_trucks" id="no_of_tow_trucks"
                                                        onchange="updateBorderColor(this)">
                                                        <option value="" disabled
                                                            <?php echo e(old('no_of_tow_trucks', optional($companyDetail)->no_of_tow_trucks) == '' ? 'selected' : ''); ?>>
                                                            Number of tow trucks</option>
                                                        <?php $__currentLoopData = range(1, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($number); ?>"
                                                                <?php echo e(old('no_of_tow_trucks', optional($companyDetail)->no_of_tow_trucks) == (string) $number ? 'selected' : ''); ?>>
                                                                <?php echo e($number); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="10+"
                                                            <?php echo e(old('no_of_tow_trucks', optional($companyDetail)->no_of_tow_trucks) == '10+' ? 'selected' : ''); ?>>
                                                            10+</option>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    <label for=""
                                                        class="mb-1 <?php echo e(empty($companyDetail) || empty($companyDetail->no_of_drivers) ? 'text-danger' : ''); ?>">No
                                                        of drivers</label>
                                                    <select
                                                        class="form-control <?php echo e(empty($companyDetail) || empty($companyDetail->no_of_drivers) ? 'border-danger' : ''); ?>"
                                                        name="no_of_drivers" id="no_of_drivers"
                                                        onchange="updateBorderColor(this)">
                                                        <option value="" disabled
                                                            <?php echo e(old('no_of_drivers', optional($companyDetail)->no_of_drivers) == '' ? 'selected' : ''); ?>>
                                                            Number of drivers</option>
                                                        <?php $__currentLoopData = range(1, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($number); ?>"
                                                                <?php echo e(old('no_of_drivers', optional($companyDetail)->no_of_drivers) == (string) $number ? 'selected' : ''); ?>>
                                                                <?php echo e($number); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="10+"
                                                            <?php echo e(old('no_of_drivers', optional($companyDetail)->no_of_drivers) == '10+' ? 'selected' : ''); ?>>
                                                            10+</option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="form-group">
                                                            <input type="checkbox" id="check3"
                                                                ...
                                                                <?php echo e($user->outbid_email_unsubscribe == 1 ? 'checked' : ''); ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-group">
                                                            <input type="checkbox" id="check4"
                                                                ...
                                                                <?php echo e($user->summary_of_leads == 1 ? 'checked' : ''); ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-group">
                                                            <input type="checkbox" id="check5"
                                                                ...
                                                                <?php echo e($user->job_email_preference == 1 ? 'checked' : ''); ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-group">
                                                            <input type="checkbox" id="check6"
                                                                ...
                                                                <?php echo e($user->new_job_alert == 1 ? 'checked' : ''); ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-group">
                                                            <input type="checkbox" id="payment1"
                                                                ...
                                                                <?php echo e(empty($payment_methods) || in_array('Cash', $payment_methods) ? 'checked' : ''); ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-group">
                                                            <input type="checkbox" id="payment2"
                                                                ...
                                                                <?php echo e(empty($payment_methods) || in_array('Bank Transfer', $payment_methods) ? 'checked' : ''); ?>>
                                                    ...
                                                    <li>
                                                        <div class="form-group">
                                                            <input type="checkbox" id="payment3"
                                                                ...
                                                                <?php echo e(in_array('Visa Card', $payment_methods) ? 'checked' : ''); ?>>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('#sendLinkBtn').on('click', function() {
            ...
            // const email = "<?php echo e(config('constants.default.admin_email')); ?>";
            ...
            // alert('yesssss');
            $.ajax({
                url: "<?php echo e(route('sendVerifyEmail')); ?>",
                type: 'POST',
                ...
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // If you're using Laravel's CSRF protection
                },
        ...
        function uploadDocuments(docs, str = '') {
            ...
            $.ajax({
                url: "<?php echo e(route('transporter.update_profile_docs')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                type: "POST",
        ...
        function uploadImage(image) {
            ...
            $.ajax({
                url: "<?php echo e(route('transporter.update_profile_image')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                type: "POST",
        ...
        $(document).ready(function() {
            ...
            <?php if(session('show_transporter_alert')): ?>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        <?php session()->forget('show_transporter_alert'); ?>
                    }
                });
            <?php endif; ?>
        ...
        function updateEmailPrefrence() {
            ...
            $.ajax({
                url: '<?php echo e(route('transporter.update_email_preference')); ?>',
                method: 'POST',
                data: {
            ...
            $('#form_account').validate({
                rules: {
                    ...
                    mobile: {
                        ...
                        remote: {
                            type: 'get',
                            url: "<?php echo e(route('front.user_availability_checker')); ?>",
                            data: {
                                id: function() {
                                    return user_id;
                                },
                    ...
                    // opassword: {
                    //     remote: {
                    //         url: "<?php echo e(route('front.check_old_password')); ?>",
                    //         type: 'get',
                    //         data: {
                    //             opassword: function () {
                    ...
                    npassword: {
                        ...
                        minlength: 6,
                        remote: {
                            url: "<?php echo e(route('front.check_new_password')); ?>",
                            type: 'get',
                            data: {
                                npassword: function() {
...
<?php echo $__env->make('layouts.transporter.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/dashboard/profile.blade.php ENDPATH**/ ?>