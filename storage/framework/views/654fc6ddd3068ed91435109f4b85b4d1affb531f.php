...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wd-active-job great_job_sec_new active_quotes">
        <div class="container great_job_sec">
            <?php if(session()->has('came_from') && session('came_from') == 'quote_save'): ?>
                <h2>Great news!</h2>
                <p class="subheader">Your job has been sent to our network of transport companies and you will start to
                    receive quotes shortly.</p>
                <ul class="checklist">
            ...
            <div class="active-job-box active_job_mobile">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="job-listing">
                        <div class="bidding_new_design_date job_new_grid_date">
                            ...
                            <span>
                                <?php echo e(formatCustomDate($item->created_at->addDays(10))); ?>
                        ...
                        <ul>
                            <?php
                                ...
                                $defaultImages = [asset('uploads/svg_image.png')];
                                $isDefaultImage = in_array($imageUrl, $defaultImages);
                                $imageClass = $isDefaultImage ? '' : 'car-image';
                            ?>
                            <li class="job-img">
                                <div class="wd-file-upload <?php echo e($imageClass); ?>">
                                    <label for="upload file" class="input-preview">
                                        <img src="<?php echo e($item->image); ?>" alt="active job" class="img-fluid"
                                            id="image_preview_<?php echo e($item->id); ?>">
                                        <p>Upload your car photo <br />(recommended)</p>
                                    </label>
                                    <input type="file" name="upload file" class="input-preview__src"
                                        id="uploadImage<?php echo e($item->id); ?>"
                                        onclick="uploadImageQuote('<?php echo e($item->id); ?>');">
                                </div>
                            </li>
                            ...
                            <li class="list_detail">
                                ...
                                <p><b><?php echo e(formatAddress($item->pickup_postcode)); ?></b></p>
                            </li>
                            ...
                            <li class="list_detail">
                                ...
                                <p>Drop-off area:</p>
                                <p><b><?php echo e(formatAddress($item->drop_postcode)); ?></b></p>
                            </li>
                            ...
                            <li class="list_detail">
                                ...
                                <p>
                                    <b>
                                        <?php if($item->delivery_timeframe_from): ?>
                                            <?php echo e(formatCustomDate($item->delivery_timeframe_from)); ?>

                                        <?php else: ?>
                                            <?php echo e($item->delivery_timeframe); ?>
                        ...
                        <div class="bidding_new_design">
                            ...
                            <?php if($transporterQuotesCount > 0): ?>
                                <div class="bidding_new_design_grid job_new_grid_lowest">
                                    ...
                                    <span class="sub_color "
                                        style="font-weight: 500">£<?php echo e(roundBasedOnDecimal($lowestBid)); ?></span>
                                </div>
                            <?php else: ?>
                                <div class="bidding_new_design_grid job_new_grid_lowest">
                                    <span>Current lowest bid:</span>
                            ...
                            <div class="bidding_new_design_grid job_new_grid_miles">
                                ...
                                <span class="sub_color  "
                                    style="font-weight: 500"><?php echo e(str_replace(' mi', '', $item->distance)); ?> <span
                                        class=" " style="font-weight: 500">(<?php echo e($item->duration); ?>)</span></span>
                            </div>

                            <?php if($transporterQuotesCount > 0): ?>
                                <div class="bidding_new_design_grid job_new_grid_bidding">
                                    <span>Transporters bidding:</span>
                                    <span class="sub_color  " style="font-weight: 500"><?php echo e($transporterQuotesCount); ?></span>
                                </div>
                            <?php else: ?>
                                <div class="bidding_new_design_grid job_new_grid_bidding">
                                    <span>Transporters bidding:</span>
                        ...
                        <!-- delete quote Modal -->
                        <div class="modal fade mark_bx" id="delete_quote_<?php echo e($item->id); ?>" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h3 class="d-block text-center">Are you sure you want to <br /> delete this quote ?
                                        </h3>
                                    </div>
                                    <div class="modal-footer p-0">
                                        <a href="javascript:;" class="no_btn" data-dismiss="modal">No</a>
                                        <a href="javascript:void(0);" onclick="deleteQuote(<?php echo e($item->id); ?>)"
                                            class="yes_btn">Yes</a>
                ...
                <?php if(count($quotes_booked) != 0): ?>
                    <h1 class="wd-active-title wd-mt-90">Recently booked deliveries</h1>
                    <?php $__currentLoopData = $quotes_booked; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $lowestBid = $item->lowest_bid ?? 0;
                            $transporterQuotesCount = $item->quotes_count ?? 0;
                        ?>
                        <div class="job-listing">
                            ...
                            <ul>
                                <li class="job-list-img">
                                    ...
                                    <div class="job-list-img-sec">
                                        <img src="<?php echo e($image); ?>" class="img-fluid" alt="book delivery">
                                        <div>
                                </li>

                                <li class="list_detail">
                                    <span>
                                        <img src="<?php echo e(asset('assets/web/images/dashboard/map-icon.svg')); ?>"
                                            alt="Map Icon">
                                    </span>
                                    <p>Pick-up postcode:</p>
                                    <p><b><?php echo e(formatAddress($item->pickup_postcode)); ?></b></p>
                                ...
                                <li class="list_detail">
                                    <span>
                                        <img src="<?php echo e(asset('assets/web/images/dashboard/red-map-icon.svg')); ?>"
                                            alt="Map Icon">
                                    </span>
                                    <p>Drop-off area:</p>
                                    <p><b><?php echo e(formatAddress($item->drop_postcode)); ?></b></p>
                                ...
                                <li class="list_detail">
                                    <span>
                                        <img src="<?php echo e(asset('assets/web/images/dashboard/car-icon.svg')); ?>"
                                            alt="Car Icon">
                                    </span>
                                    <p>Make &amp; model:</p>
                                    <p><b><?php echo e($item->vehicle_make); ?> <?php echo e($item->vehicle_model); ?></b></p>
                                ...
                                <li class="view-quote">
                                    <?php if(isset($item->quoteByTransporter)): ?>
                                        <a
                                            href="<?php echo e(route('front.user_deposit', ['id' => $item->quoteByTransporter->id])); ?>">
                                            Contact transporter
                                        </a>
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('front.leave_feedback', ['id' => $item->quoteByTransporter->id ?? null])); ?>"
                                        class="wd-blue d-sm-none">Leave feedback</a>
                                    <!-- <a href="javascript:;" class="wd-orange">View VAT receipt </a> -->
                                    <div class="d-sm-none">
                                        <?php if($item->is_mark_as_complete == 'no'): ?>
                                            <a href="javascript:;" class="wd-red"
                                                onclick="markComplete('<?php echo e($item->id); ?>')">Mark complete</a>
                                        <?php else: ?>
                                ...
                                <li class="job-access completed_jobs">
                                    <a href="<?php echo e(route('front.leave_feedback', ['id' => $item->quoteByTransporter->id ?? null])); ?>"
                                        class="wd-blue">Leave feedback</a>
                                    <!-- <a href="javascript:;" class="wd-orange">View VAT receipt </a> -->
                                    <?php if($item->is_mark_as_complete == 'no'): ?>
                                        <a href="javascript:;" class="wd-red"
                                            onclick="markComplete('<?php echo e($item->id); ?>')">Mark complete</a>
                            ...
                            <div class="bidding_new_design">
                                ...
                                <?php if($transporterQuotesCount > 0): ?>
                                    <div class="bidding_new_design_grid job_new_grid_lowest">
                                        <span>Current lowest bid:</span>
                                        <span class="sub_color">£<?php echo e(roundBasedOnDecimal($lowestBid)); ?></span>
                                    </div>
                                <?php else: ?>
                                    <div class="bidding_new_design_grid job_new_grid_lowest">
                                        <span>Current lowest bid:</span>
                                ...
                                <div class="bidding_new_design_grid job_new_grid_miles">
                                    <span>Journey miles:</span>
                                    <span class="sub_color"><?php echo e(str_replace(' mi', '', $item->distance)); ?>

                                        <span>(<?php echo e($item->duration); ?>)</span></span>
                                </div>

                                <?php if($transporterQuotesCount > 0): ?>
                                    <div class="bidding_new_design_grid job_new_grid_bidding">
                                        <span>Transporters bidding:</span>
                                        <span class="sub_color"><?php echo e($transporterQuotesCount); ?></span>
                                    </div>
                                <?php else: ?>
                                    <div class="bidding_new_design_grid job_new_grid_bidding">
                                        <span>Transporters bidding:</span>
                ...
                <?php if(!(session()->has('came_from') && session('came_from') == 'quote_save')): ?>
                    <div class="quote_grp_btns">
                        <a href="<?php echo e(route('front.home')); ?>" class="rqt_txt">Get new quote request</a>
                        <a href="<?php echo e(route('front.home')); ?>" class="quote_btn">Get quotes</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function uploadImage(image, item_id) {
            ...
            $.ajax({
                url: "<?php echo e(route('front.update_quote_image')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                type: "POST",
        ...
        function markAsComplete() {
            ...
            $.ajax({
                url: "<?php echo e(route('front.mark_as_complete_quote')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                type: "POST",
                success: function(res) {
                    if (res.success == true) {
                        window.location.href = "<?php echo e(route('front.past_deliveries')); ?>";
                    } else {
                        Swal.fire({
                            title: 'Error',
        ...
        function deleteQuote(quoteId) {
            $.ajax({
                url: "<?php echo e(route('front.quote_delete', ['id' => ':id'])); ?>".replace(':id', quoteId),
                type: "GET",
                success: function(res) {
                    if (res.success == true) {
                        Swal.fire({
        ...
        $(document).ready(function() {
            var cameFrom = "<?php echo e(session('came_from')); ?>";
...
<?php echo $__env->make('layouts.web.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/front/dashboard/index.blade.php ENDPATH**/ ?>