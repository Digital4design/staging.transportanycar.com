    ...
    <div class="modal get_quote fade" id="quote" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="main_form" method="post" action="<?php echo e(route('transporter.edit_quote_amount')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function quoteChangeStatus(quote_id, status) {
            ...
            $.ajax({
                url: "<?php echo e(route('transporter.quote_change_status')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                type: "POST",
...
<?php echo $__env->make('layouts.transporter.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/dashboard/current_jobs.blade.php ENDPATH**/ ?>