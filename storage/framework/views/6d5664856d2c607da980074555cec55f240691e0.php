    ...
    <main>
        <section class="join_network_main trans_forgotpass position-relative">
            <div class="container">
                ...
                <form class="other_forgot_account" action="<?php echo e(route('transporter.forgot_password_post')); ?>" name="form_forgot_password" id="form_forgot_password" method="post" autocomplete="off">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <a href="<?php echo e(route('transporter.login')); ?>" class="manual_link d-inline-block">Back to login</a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.transporter.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/public_html/resources/views/transporter/guest/forgot_password.blade.php ENDPATH**/ ?>