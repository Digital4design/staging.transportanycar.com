    ...
    <div class="container-admin">
        <nav class="navbar">
            <a class="brand" href="<?php echo e(route('front.home')); ?>">
                <img src="<?php echo e(site_logo); ?>" alt="logo">
            </a>
            <div class="admin-menu">
                <div class="dropdown d-lg-none d-md-none d-sm-block d-block notifaction_sec">
                   
                    <a class="menu-link dropdown-toggle noti_info_icon"href="<?php echo e(route('front.messages')); ?>" >
                    ...
                    <div class="dropdown-menu" style="display:none;">
                        ...
                        <!-- <div class="dropdown-item" href="javascript:;">
                            <div class="drop-item-lft">
                                <span class="icon-bg">
                                  <img src="<?php echo e(asset('assets/web/images/dashboard/icon1.svg')); ?>" alt="Icon">
                              </span>
                        ...
                        <?php if(isset($notifications) && $notifications->isNotEmpty()): ?>
                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="dropdown-item <?php echo e($notification->seen == 1 ? 'gray_notify' : 'white_notify'); ?>"
                                    data-type="<?php echo e($notification->type); ?>"
                                    data-id="<?php echo e($notification->type == 'message' ? $notification->reference_id : $notification->user_quote_id); ?>"
                                    data-href="
                            <?php if($notification->type == 'quote'): ?> <?php echo e(route('front.quotes', $notification->user_quote_id)); ?>

                            <?php elseif($notification->type == 'message'): ?>
                                <?php echo e(route('front.messages', ['thread_id' => $notification->reference_id])); ?> <?php endif; ?> "
                                    ...
                                    <div class="drop-item-lft notifaction_sec_list">
                                        ...
                                        <div class="notifi_time">
                                            ...
                                            <!-- <?php if($notification->type == 'quote'): ?>
                <a href="javascript:void(0)" data-href="<?php echo e(route('front.quotes', $notification->user_quote_id)); ?>" onclick="notificationStatus('<?php echo e(route('front.notification_status')); ?>', 'quote', <?php echo e($notification->user_quote_id); ?>, this);" class="view_debtn">View</a>
                <?php elseif($notification->type == 'message'): ?>
                <a href="javascript:void(0)" data-href="<?php echo e(route('front.messages', ['thread_id' => $notification->reference_id])); ?>" onclick="notificationStatus('<?php echo e(route('front.notification_status')); ?>', 'message', <?php echo e($notification->reference_id); ?>, this);" class="view_debtn">View</a>
                <?php endif; ?> -->
                                        </div>
                                    </div>
            ...
            <div class="wrapper">
                <ul class="menu">
                    <li class="menu-item <?php echo e(is_active_module_dashboard(['front.dashboard'])); ?>">
                        <a href="<?php echo e(route('front.dashboard')); ?>" id="active_deliveries">
                            <div class="noti_info_icon">
                                ...
                                <?php if($quotationCounts >= 1): ?>
                                    <small><?php echo e($quotationCounts); ?></small>
                                <?php endif; ?>
                            </div>
                            Active deliveries
                        </a>
                    </li>
                    <li class="menu-item <?php echo e(is_active_module_dashboard(['front.past_deliveries'])); ?>">
                        <a href="<?php echo e(route('front.past_deliveries')); ?>">
                    ...
                    <li class="menu-item <?php echo e(is_active_module_dashboard(['front.messages'])); ?>">
                        <a href="<?php echo e(route('front.messages')); ?>">
                    ...
                    <li class="menu-item <?php echo e(is_active_module_dashboard(['front.account'])); ?>">
                ...
                <div class="wd-profile">
                    ...
                    <a href="javascript:;" class="wd-prfol-nm">My profile :
                        <span><?php echo e(optional(Auth::guard('web')->user())->username); ?></span></a>
                </div>
            </div>
        </div>
    </nav>
...
<?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/layouts/web/dashboard/header.blade.php ENDPATH**/ ?>