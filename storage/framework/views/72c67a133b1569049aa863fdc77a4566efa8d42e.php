...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.web.only-logo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <main>
        <section class="review_quote_blog payment_cart">
          ...
          <div class="container">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
              <a href="<?php echo e(route('front.quotes', $data->user_quote_id)); ?>" class="form-wizard-previous-btn back-icon">
                ...
                <div class="row">
                  ...
                  <div class="new_text_sec col-lg-5 col-md-6">
                      <ul class="ruleslist_blog">
                        ...
                        <li>
                            <span>1</span>
                            <p>Pay deposit of <b>&nbsp;£<?php echo e(number_to_dec($data->deposit, 2,'.', '')); ?>.</b></p>
                        </li>
                        <li>
                            <span>2</span>
                            <p><b><?php echo e($transporter_name); ?></b> will contact you to make final arrangements.</p>
                        </li>
                        <li>
                            <span>3</span>
                            <p>Pay the remaining balance of <b>£<?php echo e(number_to_dec($data->transporter_payment, 2,'.', '')); ?></b> directly to the transporter on completion of the job.</p>
                        </li>
                      </ul>
                  </div>
                  <?php endif; ?>
                      ...
                      <form action="javascript:void(0)" class="form_askque" id="payment-form">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" id="submit" class="wd_get_btn" >
                              ...
                              <span id="button-text">Submit payment (£<?php echo e($data->deposit); ?>)</span>
                            </button>
                        </div>
                  ...
                  <div class="new_text_sec col-lg-5 col-md-6">
                      <ul class="ruleslist_blog">
                        ...
                        <li>
                            <span>2</span>
                            <p><?php echo e($transporter_name); ?> will contact you to make final arrangments.</p>
                        </li>
                        <li>
                            <span>3</span>
                            <p>Pay the remaining balance of <b>£<?php echo e(number_to_dec($data->transporter_payment, 2,'.', '')); ?></b> directly to  <?php echo e($transporter_name); ?>.</p>
                        </li>
                      </ul>
                  </div>
                  <?php endif; ?>
      ...
      $(document).ready(function() {
        ...
        // Fetches a payment intent and captures the client secret
          async function initialize() {
            try {
                const items = {
                  amount : "<?php echo e($data->deposit); ?>",
                  user_quote_id : "<?php echo e($data->user_quote_id); ?>",
                  quote_by_transporter_id : "<?php echo e($data->id); ?>"
                };
                const response = await $.ajax({
                url: "<?php echo e(route('front.process_payment')); ?>",
                method: "POST",
                headers: {
          ...
          async function handleSubmit() {
            ...
            const { error } = await stripe.confirmPayment({
              elements,
              confirmParams: {
                return_url: "<?php echo e(route('front.payment_confirm')); ?>",
              },
            });
          ...
          function redirectToConfirmation() {
            setTimeout(function() {
              window.location.href = "<?php echo e(route('front.payment_confirm')); ?>";
        ...
        $("#apple-pay-element").on("click", async function(e) {
            ...
            const paymentRequest = stripe.paymentRequest({
                ...
                total: {
                    ...
                    amount: parseInt(<?php echo e($data->deposit); ?>) * 100 // Amount in cents
                },
            });
            ...
            paymentRequest.on('paymentmethod', async (ev) => {
              try {
                  ...
                  const response = await $.ajax({
                      ...
                      method: "POST",
                      headers: {
                          'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', // Include CSRF token in headers
                          'Content-Type': 'application/json',
                      },
                      dataType: "json",
...
<?php echo $__env->make('layouts.web.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/public_html/resources/views/front/checkout.blade.php ENDPATH**/ ?>