...
<?php if(isset($chats) && $chats->count() > 0): ?>
    <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <?php if($quote): ?>
            <li class="<?php if($selected_chat_id == $chat->id): ?> active <?php endif; ?> user_current_chat" data-id="<?php echo e($chat->id); ?>">
                <?php if(isset($auth_user) && !empty($auth_user)): ?>
                    <a href="javascript:;" class="chat_list_info unread_msg get-chat-history" onclick="getChatHistory('<?php echo e($chat_history_url); ?>',this)">
                        <div class="chat_list_info_fst">
                            <img src="<?php echo e($quote['quote']->image); ?>" alt="Car">
                            <div class="chat_msg">
                                <h6><span><?php echo e($quote['quote']->vehicle_make); ?> <?php echo e($quote['quote']->vehicle_model); ?></span><?php if($chat->message_latest): ?> - <?php echo e($chat->message_latest->message); ?> <?php endif; ?></h6>
                                <h3>
                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="4" cy="4" r="4" fill="#52D017"/>
                                    </svg>
                                    <?php if(in_array($chat->friend_id, array_keys($transporters_name))): ?>
                                        <?php echo e(Str::limit($transporters_name[$chat->friend_id], 10)); ?>
...
</script><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/front/dashboard/partial/chat_listing.blade.php ENDPATH**/ ?>