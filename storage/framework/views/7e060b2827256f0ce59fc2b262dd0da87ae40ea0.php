    ...
    <div class="container">
        <nav class="navbar">
            <a class="brand" href="<?php echo e(route('front.home')); ?>">
                <img src="<?php echo e(asset('uploads/admin/Ol5bnQTFOlfZC5XoJIVzViwByZUt38ybdENEIfk0.png')); ?>" alt="brand_logo" />
            </a>
            ...
            <div class="wrapper">
                <ul class="menu">
                    <li id="res_logo">
                        <img src="<?php echo e(site_logo); ?>" alt="brand_logo" />
                    </li>
                    <li class="menu-item active">
                        <a href="<?php echo e(route('front.home')); ?>"> Home</a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo e(route('front.home')); ?>#chooseus" id="choose-us" > Why choose us</a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item last_menuitem">
                        <!-- <a href="tel:08081557979" class="teleph_text">
                            ...
                            <?php if(Auth::guard('web')->user() && Auth::guard('web')->user()->type == 'user'): ?>
                            <a href="<?php echo e(route('front.dashboard')); ?>" class="header_btn">
                    ...
                    <div class="menu_transport_company">
                        <p>Are you a transport company?</p><a href="<?php echo e(route('transporter.home')); ?>" class="getqt_btnincld">Sign up</a>
                    </div>
                    <?php endif; ?>
                </ul>
...
<?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/layouts/web/head-web-menu.blade.php ENDPATH**/ ?>