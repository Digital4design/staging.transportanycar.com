                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:25px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; margin-bottom: 16px;font-size:14px;">You recently clicked on ‘accept quote’ for the delivery of your <?php echo e($data['user_quotes']->vehicle_make); ?> <?php echo e($data['user_quotes']->vehicle_model); ?> but we haven’t received your deposit to secure the booking yet.</p>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:40px;padding-left:10px;padding-right:10px;padding-top:10px;">
                                                <div style="color:#ffffff;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                    ...
                                                    <p style="margin: 0;"><a href="<?php echo e(url('/manage_notification')); ?>" target="_blank" style="text-decoration: underline; color: #717171;" rel="noopener">manage notification preferences</a></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
...
<?php /**PATH /var/www/html/public_html/resources/views/mail/General/accepted-quote-without-payment.blade.php ENDPATH**/ ?>