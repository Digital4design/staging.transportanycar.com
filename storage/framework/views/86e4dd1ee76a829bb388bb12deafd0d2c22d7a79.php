                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:50px;padding-right:50px;padding-top:30px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; margin-bottom: 16px;">You currently have <?php echo e($data['pendingQuotesCount']); ?> quotes for transporting your <?php echo e($data['quote']->vehicle_make); ?> <?php echo e($data['quote']->vehicle_model); ?>.</p>
...
<?php /**PATH /var/www/html/public_html/resources/views/mail/General/total-quotes-recieved-notification.blade.php ENDPATH**/ ?>