...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            let baseUrl = "<?php echo e(url('/')); ?>"; // Define Laravel base URL in JavaScript
            ...
            oTable = $('#listResults').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('admin.carTransporter.review_data')); ?>",
                    "type": "GET",
                    "data": function(d) {
                        d.start = d.start || 0;
            ...
            $(document).on('click', '.jobCompleted_form', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.carTransporter.custom_jobCompleted')); ?>',
                    method: 'POST',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/admin/carTransporter/transporter_review.blade.php ENDPATH**/ ?>