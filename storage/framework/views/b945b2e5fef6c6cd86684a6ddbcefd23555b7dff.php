...
<div class="jobsrch_form_blog search_resu_sec mb-0" style="display:block !important">
    <div class="form-group where_custom">
        ...
        <input style="text-transform:capitalize;" type="text" class="form-control" name="search_pick_up_area" id="search_pick_up_area"
            placeholder="<?php echo e($pickup); ?> - <?php echo e($dropoff); ?>" disabled />
...
<div class="srch-data">
    ...
    <a href="<?php echo e(route('transporter.new_jobs_new')); ?>">Reset Search</a>
</div>
    ...
    <div class="boxContent">
        <div class="boxContentList" id="search-results">
            ...
            <div class="boxImg-text car-row" data-car-id="<?php echo e($quote->id); ?>">
                ...
                <div class="imgCol">
                    <img src="<?php echo e($quote->image ? env('APP_URL') . '/' . $quote->image : env('APP_URL') . '/uploads/no_car_image.png'); ?>"
                        class="" alt="image" />
                </div>
            ...
            <div class="contentBlockBtn">
                <div class="leftList">
                    <ul class="col-6 px-0 car-row" data-car-id="<?php echo e($quote->id); ?>">
                        <li>
                            <b>Expiry date:</b>
                            <span class="font-weight-light">
                                <?php echo e(formatCustomDate($modifiedDate)); ?>
                        ...
                        <li class="colorDivBlue">
                            ...
                            <?php if($quote->delivery_timeframe_from): ?>
                                <span class="sub_color"><?php echo e(formatCustomDate($quote->delivery_timeframe_from)); ?></span>
                            <?php else: ?>
                                <span class="sub_color"><?php echo e($quote->delivery_timeframe); ?></span>
                            <?php endif; ?>
                        </li>
                        ...
                        <li class="colorDivBlue">
                            <b>Journey miles:</b>
                            <span class="sub_color"><?php echo e(str_replace(' mi', '', $quote->distance)); ?></span>
                    ...
                    <ul class="col-6 px-0">
                        ...
                        <?php if($transporterQuotesCount > 0): ?>
                            <li class="colorDivgreen car-row" data-car-id="<?php echo e($quote->id); ?>">
                        ...
                        <?php endif; ?>
                        <li class="colorDivBlue  mb-2 car-row" data-car-id="<?php echo e($quote->id); ?>">
                        ...
                        <li class="row mx-0 w-100 align-items-end mb-0">
                            <div class="btnCol">
                                ...
                                <?php if($quote->tranporterId == auth()->user()->id): ?>
                            ...
                            <div class="iconDiv ml-4">
                                <?php if($quote->watchlist_id == '0'): ?>
                                    <a href="javascript:;" style="margin-left: auto;" class=""
                                        onclick="addToWatchlist('<?php echo e($quote->id); ?>');" style="margin-left: auto;">
                                ...
                                <?php else: ?>
                                    <a href="javascript:;" onclick="removeToWatchlist('<?php echo e($quote->id); ?>');"
                ...
                <?php else: ?>
                    <?php if($quote->created_at->timezone('Europe/London') > now('Europe/London')->subHour()): ?>
                        <div class="actionDiv">
...
<?php if($quotes->currentPage() == $quotes->lastPage()): ?>
    <div class="search_sec_footer">
        <div class="conatiner srch-data">
            <span>That’s all for now. Why not try<br>
                <a href="<?php echo e(route('transporter.new_jobs_new')); ?>">editing your search</a> for more jobs.
            </span>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH /var/www/html/public_html/resources/views/transporter/dashboard/partial/search_job_result.blade.php ENDPATH**/ ?>