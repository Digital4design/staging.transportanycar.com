                            ...
                            <?php else: ?>
                                <div class="job-data">
                                    <?php if($quotes->total() > 50): ?>
                                        <span class="pl-0">Results: <?php echo e($quotes->firstItem()); ?>-<?php echo e($quotes->lastItem()); ?>

                                            of
                                            <?php echo e($quotes->total()); ?></span>
                                    <?php else: ?>
                                        <?php if($quotes->firstItem() == $quotes->lastItem()): ?>
                                            <span class="pl-0">Results: <?php echo e($quotes->firstItem()); ?> of
                                                <?php echo e($quotes->total()); ?></span>
                                        <?php else: ?>
                                            <span class="pl-0">Results:
                                                <?php echo e($quotes->firstItem()); ?>-<?php echo e($quotes->lastItem()); ?> of
                                                <?php echo e($quotes->total()); ?></span>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                                                        ...
                                                        <div class="leftList">
                                                            ...
                                                            <ul class="col-6 px-0">
                                                                ...
                                                                <li class="row mx-0 w-100 align-items-end mb-0">
                                                                    <div class="btnCol">
                                                                        <?php if($quote->quoteByTransporterCheck): ?>
...
<?php echo $__env->make('layouts.transporter.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/watchlist/index.blade.php ENDPATH**/ ?>