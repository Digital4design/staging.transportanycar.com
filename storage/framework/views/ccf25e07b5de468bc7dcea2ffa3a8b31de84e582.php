...
<?php $__env->startSection('css'); ?>
    <!-- DataTables -->
    <link href="<?php echo e(URL::asset('/assets/admin/vendors/general/datatable/jquery.dataTables.min.css')); ?>" id="bootstrap-style"
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18"> Fake Reviews</h4>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            let userId = "<?php echo e($data->id); ?>"; // Get user ID from Blade
            let baseUrl = "<?php echo e(url('/')); ?>";

            $(document).ready(function() {
                let userId = "<?php echo e($data->id); ?>"; // Assuming the user ID is available in Blade
                loadReviews(userId);
            });

            function loadReviews(userId) {
                $.ajax({
                    url: "<?php echo e(route('admin.carTransporter.review_show_data', ':id')); ?>".replace(':id',
                        userId), // Dynamic ID
                    method: "GET",
            ...
            $(document).on('click', '.lve_feed_btn', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.carTransporter.review_data_update')); ?>',
                    method: 'POST',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
            ...
            $(document).on('click', '.create_lve_feed_btn', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.carTransporter.review_data_save')); ?>',
                    method: 'POST',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/admin/carTransporter/view_review.blade.php ENDPATH**/ ?>