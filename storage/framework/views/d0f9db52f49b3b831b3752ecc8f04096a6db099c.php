        ...
        <div class="container-job">
            <div class="active-job-box">
                ...
                <div class="chat_box">
                    ...
                    <!-- right chat box -->
                    <input type="hidden" id="user_current_chat_id" value="<?php if($latest_chat): ?> <?php echo e($latest_chat->id); ?> <?php else: ?> 0 <?php endif; ?>">
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        ...
        function getChatListing(){
            ...
            $.ajax({
                url: "<?php echo e(route('front.message.chat_list')); ?>",
        ...
        $(document).ready(function () {
            ...
            var url = "<?php echo e(route('front.message.history',($latest_chat->id) ?? 0)); ?>"
            getChatHistory(url,$(".get-chat-history")[0]);
        });
...
<?php echo $__env->make('layouts.web.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/front/dashboard/messages.blade.php ENDPATH**/ ?>