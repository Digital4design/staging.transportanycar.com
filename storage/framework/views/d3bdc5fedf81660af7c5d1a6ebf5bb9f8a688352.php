                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="wd_email_form">
                            ...
                            <form class="wd-login-form p-0" action="<?php echo e(route('front.inquiry')); ?>" id="inquirySubmit" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg-12">
                ...
                <!-- <div class="row wd-cont-detail">
                    <div class="col-lg-4">
                        <div class="wd-loc-icon">
                            <div class="map-icon">
                                <img src="<?php echo e(asset('assets/web/images/icon6.png')); ?>">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="wd-loc-icon">
                            <div class="map-icon">
                                <img src="<?php echo e(asset('assets/web/images/icon5.png')); ?>">
                            </div>
                            <div class="wd-map-txt">
                                <h3> Phone</h3>
                                <p>0808 155 7979</p>
...
<?php echo $__env->make('layouts.web.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/public_html/resources/views/front/contact.blade.php ENDPATH**/ ?>