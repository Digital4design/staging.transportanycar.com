                                            ...
                                            <td class="pad" style="width:100%;">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    <div style="max-width: 600px;">
                                                        <img src="<?php echo e(asset('assets/images/document-upload.png')); ?>" style="display: block; height: auto; border: 0; width: 100%;" width="600" alt="Document upload" title="Document upload">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="pad" style="padding-bottom:10px;padding-left:50px;padding-right:50px;padding-top:5px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0;"><strong><b>Full name:</b> 
                                                        <span><?php echo e($user['first_name']); ?></span></strong></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td class="pad" style="padding-bottom:10px;padding-left:50px;padding-right:50px;padding-top:5px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0;"><strong><b>Company name:</b> 
                                                        <span><?php echo e($user['name']); ?></span></strong></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td class="pad" style="padding-bottom:10px;padding-left:50px;padding-right:50px;padding-top:5px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0;"><strong><b>Username:</b> 
                                                        <span><?php echo e($user['username']); ?></span></strong></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table> 
...
</html><?php /**PATH /var/www/html/public_html/resources/views/mail/General/transporter-upload-documents.blade.php ENDPATH**/ ?>