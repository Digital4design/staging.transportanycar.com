    ...
    <main>
        <section id="home" class="wd_banner">
            <div class="container">
                ...
                <?php endif; ?>
                <form class="newform_getqt" id="transportQuote" method="post" action="<?php echo e(route('front.set_location')); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <img src="<?php echo e(asset('assets/web/images/star_rate.png')); ?>" alt="icon" class="star_rating" />
                ...
                <div class="row card_blogchoose">
                    <div class="col-lg-4 col-md-6">
                        <div class="choose_card">
                            ...
                            <img src="<?php echo e(asset('assets/web/images/home/car-vehicle-motor-crossover-transportation.svg')); ?>" alt="image" />
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="choose_card">
                            ...
                            <img src="<?php echo e(asset('assets/web/images/home/car-vehicle-transportation-automobile-sedan.svg')); ?>" alt="image" />
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="choose_card">
                            ...
                            <img src="<?php echo e(asset('assets/web/images/home/car-vehicle-motor-automobile-supercar.svg')); ?>" alt="image" />
                        </div>
                ...
                <div class="row row-reverse">
                    <div class="col-lg-6 col-md-6">
                        <div class="wd_title text-left">
                            ...
                            <img src="<?php echo e(asset('assets/web/images/home/login_right_newph.png')); ?>" alt="image" class="choose_carimg phimg_right"  />
                    ...
                    <div class="col-lg-6 col-md-6 carbg_resblog mt-auto">
                        <img src="<?php echo e(asset('assets/web/images/home/login_right_new.png')); ?>" alt="image" class="choose_carimg deskimg_right"  />
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="item">
                        <div class="reviewblog">
                            <div class="review_topblog">
                                <img src="<?php echo e(asset('assets/web/images/home/starating.svg')); ?>" class="star_rating" alt="object" />
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('assets/web/vendors/owl.carousel/js/owl.carousel.min.js')); ?>"></script>
    ...
    <script>
        ...
        const europeanCountries = <?php echo json_encode(config('constants.european_countries'), 15, 512) ?>;
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(get_constants('google_map_key')); ?>&loading=async&libraries=places&callback=initMap"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.web.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/front/index.blade.php ENDPATH**/ ?>