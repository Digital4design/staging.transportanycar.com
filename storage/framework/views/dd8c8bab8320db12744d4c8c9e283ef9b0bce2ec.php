...
<?php if(isset($user) && !empty($user)): ?>
    <div class="chat_conversation_header">
        ...
        <div class="conversation_user transportor-chat-header d-flex flex-wrap align-items-center text-left">
            <div style="border-radius:5px; overflow: hidden; flex: 1 0 0;">
                <?php if($quote->image == NULL): ?>
                <img src="<?php echo e(asset('uploads/no_car_image.png')); ?>" alt="" width="80" height="50"
                style="max-width: 100%;" />
                <?php else: ?>
                
                    <img src="<?php echo e($quote->image); ?>" alt="" width="80" height="50"
                    style="max-width: 100%;" />
                 <?php endif; ?>  
            </div>
            <div>
                ...
                <ul>
                    <li>
                        ...
                        <span class="ml-1"><?php echo e($quote->pickup_postcode ? hidePostcode(get_last_two_parts($quote->pickup_postcode)): '-'); ?></span>
                    </li>
                    <li>
                        <svg width="10" height="16" viewBox="0 0 16 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="ml-1"><?php echo e($quote->drop_postcode ? hidePostcode(get_last_two_parts($quote->drop_postcode)) : '-'); ?></span>
                    </li>
                </ul>
                                ...
                                <div class="chat_txt_bx">
                                    ...
                                    <div class="chat_incoming_txt">
                                        ...
                                        <span class="chat_time">
                                            <?php if(carbon\carbon::parse($message->created_at)->diffInHours() < 24): ?>
                                                <?php echo e(carbon\carbon::parse($message->created_at)->format('h:i A')); ?>
    ...
    <div class="chat_conversation_footer">
        ...
        <form id="chat__form" action="<?php echo e(route('transporter.message.store', $thread->user_quote_id)); ?>" method="post"
            ...
            <input type="hidden" value="<?php echo e($transaction); ?>" id="transactionValid">
        </form>
...
<?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/dashboard/partial/history_listing.blade.php ENDPATH**/ ?>