...
<style>
    ...
    .card .card-header .wd-quote-btn .wd-view-btn {
    ...
    .verified-icon .icon_hover_sec {
        display: none;
    }

    .wd-quote-area .wd-quote-data .wd-quote-txt p {
        padding-left: 45px;
        padding-right: 45px;
    }
    ...
    @media(max-width: 580px) {
        ...
        .card .card-header .wd-quote-btn .wd-view-btn span {
            display: none;
        }
        ...
        .verified-icon .info_sec_details:before {
            right: 110px;
        }
        ...
        .wd-quote-area .wd-quote-data .wd-quote-txt {
            background: #ffffff;
            border: 1px solid #CFCFCF;
        ...
        .wd-quote-area .wd-quote-data .wd-quote-txt p svg {
            position: absolute;
            left: 15px;
            top: 0;
            bottom: 0;
        ...
        .wd-quote-area .wd-quote-data .wd-quote-table-head {
            display: none;
        }
        ...
        .wd-quote-area .wd-quote-data .card_lft .mobile-wrap {
            width: 100%;
        ...
        .wd-quote-area .wd-quote-data .card_lft .mobile-wrap.rating-mobile-wrap {
            margin-bottom: 0;
            margin-top: 10px;
        }
        ...
        .wd-quote-area .wd-quote-data .card_lft+.wd-quote-btn a {
            width: 100%;
            justify-content: center;
        }

        .wd-quote-area .wd-quote-data .accordion .card-body {
            background: #ffffff;
        }
    ...
    @media(min-width: 581px) {
        ...
        .rating-star.choose_quote_rating {
            justify-content: center;
            text-align: center !important;
        }
    }
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wd-quote-area bradius_10">
        <div class="row align-items-center align-items-md-end header-part">
            <div class="col-12 col-md-6">
                <div class="wd-quote-title">
                    ...
                    <p>You have received <?php echo e(count($quotes)); ?> quotes so far, choose the best one based on price and
                        convenience and click accept to secure your booking.</p>
                </div>
            </div>
            <div class="help col-12 col-md-6 px-0 px-sm-3 py-3 pb-sm-0 py-md-0">Need help? Call us <a
                    href="tel:08081557979">0808 155 7979</a></div>
        </div>
        <div class="wd-quote-data">
            ...
            <div class="wd-quote-table-head">
                <div class="wd-quote-head">
                    <div class="d-flex flex-wrap" style="width:calc(100% - 350px);">
                        <p class="quote-table-transport" style="max-width:20%; flex: 0 0 20%; text-align:left;">Transporter
                        </p>
                        <p class="quote-table-Rating" style="max-width:20%; flex: 0 0 20%; text-align:center;">Rating</p>
                        <p class="quote-table-Verified" style="max-width:20%; flex: 0 0 20%; text-align:center;">Verified
                        </p>
                ...
                <div class="accordion" id="accordionExample">
                    <?php $__currentLoopData = $quotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($quote->status != 'rejected'): ?>
                            <div class="card">
                                <div class="card-header <?php if($key == 0): ?> active <?php endif; ?>"
                                    id="heading<?php echo e($key); ?>">
                                    <div class="card_lft" style="width:calc(100% - 350px);">
                                        <div class="d-flex flex-wrap align-items-center mobile-wrap first-mobile-wrap"
                                            ...
                                            <a href="<?php echo e(route('front.feedback_view', $quote->id)); ?>">
                                                <h4 style="line-height: 24px;">
                                                    <?php echo e($quote->getTransporters->username ?? ''); ?>

                                                    (<?php echo e($quote->getTransporters->completed_job ?? ''); ?>)
                                                </h4>
                                            </a>
                                        </div>
                                        <div class="mobile-wrap rating-mobile-wrap"
                                            ...
                                            <?php if($quote->percentage == 0): ?>
                                                <ul class="rating-star choose_quote_rating">
                                                    ...
                                                    <li><span class="ml-1">(<?php echo e($quote->percentage); ?>%)</span></li>
                                                </ul>
                                            <?php else: ?>

                                                <?php
                                                    $totalStars = 5; // Total number of stars
                                                    $ratingAverage = $quote->rating_average;
                                                    $yellowStars = floor($ratingAverage); // Full yellow stars (integer part)
                                                    $halfStar = $ratingAverage - $yellowStars >= 0.5; // Check if there is a half-star
                                                ...
                                                <ul class="wd-star-lst user-feedback-stars">
                                                    ...
                                                    <li>
                                                        <span class="ml-1">
                                                            (<?php echo e($quote->percentage == floor($quote->percentage)
                                        ...
                                        <div class="mobile-wrap" style="max-width:20%; flex: 0 0 20%; text-align:center;">
                                            ...
                                            <span class="verified-icon">
                                                <svg width="27" height="27" viewBox="0 0 18 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M16.9965 5.3326C17.1504 13.7554 12.1262 17.3386 9.2776 18.184C9.08891 18.2401 8.88795 18.2401 8.69926 18.184C5.89741 17.3534 1.01723 13.876 1 5.75221C1.01688 5.05019 1.41171 4.41206 2.03239 4.08364C6.36869 1.63494 8.45439 1 8.98474 1C9.51509 1 11.7657 1.67555 16.3899 4.32236C16.756 4.52867 16.9865 4.91248 16.9965 5.3326Z"
                                                        stroke="#52D017" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path d="M5.30664 9.63198L7.76765 12.093L12.6897 7.16113"
                                                        stroke="#52D017" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                                <div class="icon_hover_sec">
                                                    <a class="hover_anchor">
                                                        <img src="<?php echo e(asset('assets/web/images/question.png')); ?>"
                                                            alt="question" />
                                                    </a>
                                                    <div class="info_sec_details" id="infos-details">
                                                        <div class="info_sec_details_contant">
                                                            <p>We have verified this transport providers insurance cover and
                                                                drivers license to protect you and transport vehicles safe
                                                                and
                                                                securely.</p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="mobile-wrap" style="max-width:20%; flex: 0 0 20%;">
                                            ...
                                            <div class="icon_hover_sec">
                                                <div class="flex_blog "><span>Flexible</span>
                                                    <a class="hover_anchor" data-toggle="popover" data-placement="bottom"
                                                        data-content="Accept the quote and the transporter will contact you to arrange a convenient time and date."><img
                                                            src="<?php echo e(asset('assets/web/images/question.png')); ?>"
                                                            alt="question"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mobile-wrap" style="max-width:20%; flex: 0 0 20%; text-align:center;">
                                            ...
                                            <h5 class="amount">£<?php echo e($quote->price); ?> <span class="no-due">(No fees)</span>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="wd-quote-btn" style="width: 350px;">
                                        <a href="javascript:;" class="wd-view-btn messageShow justify-content-center"
                                            data-msgkey="<?php echo e($key); ?>" type="button" data-toggle="collapse"
                                            data-target="#collapse<?php echo e($key); ?>" aria-expanded="true"
                                            aria-controls="collapseOne">View messages
                                            <span class="msg_<?php echo e($quote->thread_id ?? 0); ?>">0</span>
                                        </a>
                                        <?php if($quote->status == 'pending' && !$hasAcceptedQuote): ?>
                                            <a href="javascript:;"
                                                onclick="quoteChangeStatus(<?php echo e($quote->id); ?>, 'accept');"
                                            ...
                                            <a href="javascript:;" data-toggle="modal"
                                                data-target="#delete_quote_<?php echo e($quote->id); ?>"
                                                class="d-lg-block delete_cross">
                                        ...
                                        <?php elseif($quote->status == 'accept'): ?>
                                            <?php if($job_status != 'completed'): ?>
                                                <a href="<?php echo e(route('front.booking_confirm_page', $user_quote_id)); ?>"
                                                    class="wd-accepted-btn">Go
                                                    to booking</a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('front.user_deposit', ['id' => $quote->id])); ?>"
                                                    class="wd-accepted-btn">Go
                                                    to booking</a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                ...
                                <!-- delete quote Modal -->
                                <div class="modal fade mark_bx" id="delete_quote_<?php echo e($quote->id); ?>" tabindex="-1"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer p-0">
                                                ...
                                                <a href="javascript:void(0)"
                                                    onclick="quoteChangeStatus(<?php echo e($quote->id); ?>, 'rejected');"
                                                    class="yes_btn">Yes</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="collapse<?php echo e($key); ?>"
                                    class="collapse <?php if($key == 0): ?> show <?php endif; ?>"
                                    aria-labelledby="heading<?php echo e($key); ?>" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <form id="chat__form_<?php echo e($key); ?>"
                                            action="<?php echo e(route('front.message.quote_send_message')); ?>" method="post"
                                            ...
                                            <input type="hidden" name="transporter_id" value="<?php echo e($quote->user_id); ?>">
                                            <input type="hidden" name="user_quote_id"
                                                value="<?php echo e($quote->user_quote_id); ?>">
                                            <input type="hidden" name="user_current_chat_id"
                                                id="user_current_chat_id_<?php echo e($key); ?>"
                                                value="<?php echo e($thread ? $thread->id : 0); ?>">
                                            <div class="wd-quote-form bid_wrapper">
                                                <div class="form-group">
                                                    ...
                                                    <p class="chat-note text-left font-weight-light position-relative"
                                                        style="font-size:14px; padding-left:20px; margin-top: 5px; color:#444444;">
                                                        <svg width="19" height="19" viewBox="0 0 19 19"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg"
                                                            class="position-absolute" style="left:0; top:-2px;">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                d="M15.5631 12.2653L10.9587 4.78559C10.655 4.27279 10.1032 3.95831 9.50721 3.95831C8.91121 3.95831 8.35943 4.27279 8.05569 4.78559L3.45057 12.2653C3.10235 12.8105 3.07241 13.5003 3.37208 14.0737C3.67176 14.647 4.25525 15.0163 4.90169 15.0416H14.1119C14.7584 15.0163 15.3419 14.647 15.6416 14.0737C15.9412 13.5003 15.9113 12.8105 15.5631 12.2653Z"
                                                                stroke="#5B5B5B" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                                            <path d="M9.50682 10.2916V6.33329" stroke="#5B5B5B"
                                                                stroke-width="1.5" stroke-linecap="round"></path>
                                                            <path d="M9.50682 12.6666V11.875" stroke="#5B5B5B"
                                                                stroke-width="1.5" stroke-linecap="round"></path>
                                                        </svg>
                                                ...
                                                <div class="wd-form-btn">
                                                    ...
                                                    <a href="javascript:;" class="send-msg"
                                                        onclick="sendMessage(<?php echo e($key); ?>);"
                                                        id="send_message">Send
                                                        message
                                                    ...
                                                    <p class="text-note d-none"><span>Note:</span> Please do not share any
                                                        contact information here,
                                                        details are exchanged after you have accepted the quote.</p>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="wd-quote-msg" id="chat_history_main_<?php echo e($key); ?>">
            ...
            <?php else: ?>
                <div class="wd-quote-txt" style="border-bottom:1px solid #CFCFCF; border-radius: 10px;">

                    <p class="text-center">Your quotes will appear here within minutes but may take longer sometimes.</p>
                    <img src="<?php echo e(asset('assets/web/images/clock.png')); ?>" alt="" width="75"
                        class="mx-auto my-4 d-block" />
                    <p class="text-center">The most competitive quotes usually takes 24 hours.</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(() => {
            ...
            // Check if 'type=email' exists in the URL
            if (urlParams.get('type') === 'email') {
                // Animate scrolling to the #accordionExample element
                $('html, body').animate({
        ...
        function quoteChangeStatus(quote_id, status) {
            ...
            $.ajax({
                url: "<?php echo e(route('front.quote_change_status')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                type: "POST",
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function updateChat() {
                ...
                if (selected_chat_id) {
                    var url = "<?php echo e(route('front.message.quote_history', ':chat_id')); ?>";
     ...
     <script>
        document.addEventListener("DOMContentLoaded", function() {
            let scrollToElement = "<?php echo e($scroll ?? ''); ?>"; // Get scroll parameter
...
<?php echo $__env->make('layouts.web.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/front/dashboard/quotes.blade.php ENDPATH**/ ?>