                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    ...
                                                    <p style="margin: 0; font-size: 14px;"><a href="<?php echo e(route('front.unsubscribe', ['unsub' => true])); ?>" target="_blank" style="text-decoration: underline; color: #5f5f5f;" rel="noopener">Unsubscribe from all emails</a></p>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:20px;padding-left:60px;padding-right:60px;padding-top:25px;">
                                                <div style="color:#000f26;direction:ltr;font-family:'Montserrat', sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                    <p style="margin: 0; margin-bottom: 16px;">Your quotes for <?php echo e($data['quote']->vehicle_make); ?> <?php echo e($data['quote']->vehicle_model); ?> delivery will expire in 2 days.</p>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:40px;padding-left:10px;padding-right:10px;padding-top:10px;">
                                                <div style="color:#ffffff;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                    ...
                                                    <p style="margin: 0;"><a href="<?php echo e(route('front.unsubscribe', ['unsub' => true])); ?>" target="_blank" style="text-decoration: underline; color: #717171;" rel="noopener">Unsubscribe from all emails</a></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
...
<?php /**PATH /var/www/html/public_html/resources/views/mail/General/expiring-quotes.blade.php ENDPATH**/ ?>