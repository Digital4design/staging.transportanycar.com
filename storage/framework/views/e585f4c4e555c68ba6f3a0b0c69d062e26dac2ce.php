...
<!-- App Css-->
<link href="<?php echo e(URL::asset('/assets/css/app.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
<!-- Custom CSS -->
<link href="<?php echo e(URL::asset('/assets/css/custom.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
<!-- Custom Responsive -->
<link href="<?php echo e(URL::asset('/assets/css/responsive.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
...
</style><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/layouts/head-css.blade.php ENDPATH**/ ?>