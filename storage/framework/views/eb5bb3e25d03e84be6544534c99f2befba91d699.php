...
$findJobsPath = parse_url(
    route('transporter.new_jobs_new', [], false),
                            ...
                            <div class="col-5 date mb-3 pr-0 pr-md-3 text-right">
                                Posted <?php echo e(getTimeAgo($quote->created_at->toDateTimeString())); ?>
                        ...
                        <div class="wrapper row">
                            <div
                                ...
                                <div class="img_wrap">
                                    ...
                                    <img src="<?php echo e($quote->image); ?>" alt="image" width="92" height="57"
                                ...
                                <div class="car-content">
                                    <?php if(!is_null($quote->vehicle_make_1) && !is_null($quote->vehicle_model_1)): ?>
                                        <div class="car-title"> <?php echo e($quote->vehicle_make); ?>

                                            <?php echo e($quote->vehicle_model); ?> / <?php echo e($quote->vehicle_make_1); ?>

                                            <?php echo e($quote->vehicle_model_1); ?></div>
                                    <?php else: ?>
                                        <div class="car-title">
                                            <?php echo e($quote->vehicle_make); ?>

                                            <?php echo e($quote->vehicle_model); ?>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center position-relative pl-3">
                                        ...
                                        <span><?php echo e($quote->pickup_postcode ? hidePostcode(get_last_two_parts($quote->pickup_postcode)) : '-'); ?></span>
                                    </div>
                                    <div class="d-flex flex-wrap align-items-center position-relative pl-3">
                                        <svg class="position-absolute" style="left:0; top:0;" width="10" height="16"
                                            viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <span><?php echo e($quote->drop_postcode ? hidePostcode(get_last_two_parts($quote->drop_postcode)) : '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 d-flex flex-wrap align-items-center upper-left">
                                        <div class="row w-100 ">
                                            <div
                                                ...
                                                <span class="value">
                                                    <?php echo e(formatCustomDate($quote->created_at->addDays(10))); ?></span>
                                            </div>
                                            <div
                                                class="wrap d-flex flex-wrap flex-md-column col-12 col-md-4 delivery mb-2 mb-md-0">
                                                <span class="label">Delivery date:</span>
                                                <?php if($quote->delivery_timeframe_from): ?>
                                                    <span
                                                        class="value"><?php echo e(formatCustomDate($quote->delivery_timeframe_from)); ?></span>
                                                <?php else: ?>
                                                    <span class="value"><?php echo e($quote->delivery_timeframe); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 d-flex flex-wrap align-items-center upper-right my-md-3">
                                        <div class="row w-100 ">
                                            <div class="wrap d-flex flex-wrap flex-md-column col-12 col-md-4 mb-2 mb-md-0">
                                                ...
                                                <?php if($quote->vehicle_make_1): ?>
                                                    <?php if($quote->starts_drives == '1' && $quote->starts_drives_1 == '0'): ?>
                                                        <span class="value">Yes/No</span>
                                                    <?php elseif($quote->starts_drives == '0' && $quote->starts_drives_1 == 'on'): ?>
                                                        <span class="value">No/Yes</span>
                                                    <?php elseif($quote->starts_drives == '1' || $quote->starts_drives_1 == 'on'): ?>
                                                        <span class="value">Yes</span>
                                                    <?php elseif($quote->starts_drives == '0' && $quote->starts_drives_1 == '0'): ?>
                                                        <span class="value">No</span>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <?php if($quote->starts_drives == '1'): ?>
                                                        <span class="value">Yes</span>
                                                    <?php else: ?>
                                                        <span class="value">No</span>
                                                    <?php endif; ?>
                                            ...
                                            <div class="wrap d-flex flex-wrap flex-md-column col-12 col-md-4 mb-2 mb-md-0">
                                                ...
                                                <span class="value"> <?php echo e($quote->how_moved); ?></span>
                                            </div>
                                            <div class="wrap d-flex flex-wrap flex-md-column col-12 col-md-4">
                                                <span class="label">Journey miles:</span>
                                                <span class="value"><?php echo e(str_replace(' mi', '', $quote->distance)); ?>

                                                    (<?php echo e($quote->duration); ?>)</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="wishlist_wrap row align-items-center">
                                    <div
                                        ...
                                        <div class="row w-100 mx-0">
                                            <?php if($quote->watchlist): ?>
                                                <a href="javascript:;" class="add_to_wishlist"
                                                    onclick="removeToWatchlist('<?php echo e($quote->id); ?>');">

                                                    Add to watchlist
                                                </a>
                                            <?php else: ?>
                                                <a href="javascript:;" class="add_to_wishlist"
                                                    onclick="addToWatchlist('<?php echo e($quote->id); ?>');">
                                                    Add to watchlist
                                                </a>
                                            <?php endif; ?>
                                    ...
                                    <div
                                        ...
                                        <div class="row w-100 lower-left">
                                            <div
                                                ...
                                                <?php if($transporterQuotesCount > 0): ?>
                                                    <span class="label">Current lowest bid:</span>
                                                    <span class="value price ml-1">£<?php echo e($lowestBid); ?></span>
                                                <?php else: ?>
                                                    <span class="label">Current lowest bid:</span>
                                            ...
                                            <div
                                                ...
                                                <?php if($transporterQuotesCount > 0): ?>
                                                    <span
                                                        class="value bid_count ml-1"><?php echo e($transporterQuotesCount); ?></span>
                                                <?php else: ?>
                                    ...
                                    <div class="col-12 d-flex flex-wrap align-items-end upper-right px-0 px-md-3">
                                        <div class="row w-100 mx-0">
                                            ...
                                            <div class="place_bid_wrap view-quote my-0 ml-md-2 mr-0">
                                                <?php if($quote->quoteByTransporter): ?>
                                                    <a href="javascript:;"
                                                        onclick="share_edit_quote('<?php echo e($quote->id); ?>');"
                                                        class="place_bid_btn ">Edit
                                                        bid</a>
                                                <?php else: ?>
                                                    <a href="javascript:;"
                                                        onclick="share_give_quote('<?php echo e($quote->id); ?>');"
                        ...
                        <div class="bid_wrapper">
                            ...
                            <?php if($quotebytransporters->isNotEmpty()): ?>
                                <div class="accordion" id="accordionBids">
                                    <?php $__currentLoopData = $quotebytransporters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transporter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="card bg-transparent border-0 rounded-0">
                                            <div class="card-header bg-white border-0 justify-content-between"
                                                id="bid<?php echo e($key); ?>">
                                                <?php if($lowestBid == round($transporter->transporter_payment)): ?>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="bidder_name mb-1">
                                                            <?php if($transporter->getTransporters->id === Auth::user()->id): ?>
                                                                (You)
                                                            <?php endif; ?>
                                                            <span><?php echo e($transporter->getTransporters->username); ?></span>
                                                        </div>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center">
                                                    <div>
                                                        <div class="bidder_bid">
                                                            <?php echo e($transporter->getTransporters->id === Auth::user()->id ? 'Your bid' : 'Current bid'); ?>:
                                                            <span>£<?php echo e(round($transporter->transporter_payment)); ?></span>
                                                        </div>

                                                        <button
                                                            class="btn view_message <?php echo e($transporter->getTransporters->id === Auth::user()->id ? 'login-user-button' : ''); ?>"
                                                            type="button" data-toggle="collapse"
                                                            data-target="#bidCollapse<?php echo e($key); ?>"
                                                            aria-expanded="<?php echo e($key == 0 ? 'true' : 'false'); ?>"
                                                            aria-controls="bidCollapse<?php echo e($key); ?>">
                                                            <?php echo e($transporter->getTransporters->id === Auth::user()->id ? 'Your messages' : 'View messages'); ?>

                                                            <span
                                                                class="message_count"><?php echo e($transporter->count_messages); ?></span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>

                                            <div id="bidCollapse<?php echo e($key); ?>"
                                                class="collapse <?php echo e($key == 0 ? 'show' : ''); ?>"
                                                aria-labelledby="bid<?php echo e($key); ?>" data-parent="#accordionBids">
                                                <div class="card-body">

                                                    <div class="message-container">
                                                        <?php $__currentLoopData = $transporter->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $set => $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="message-info <?php if($set < $transporter->messages->count() - 2): ?> hidden-message <?php endif; ?>"
                                                                <?php if($set < $transporter->messages->count() - 2): ?> style="display: none;" <?php endif; ?>>
                                                                <p>
                                                                    <?php if($message->sender->type == 'car_transporter'): ?>
                                                                        <?php if($message->sender->id === Auth::user()->id): ?>
                                                                            <span>You</span>
                                                                        <?php else: ?>
                                                                            <span><?php echo e($message->sender->username); ?></span>
                                                                        <?php endif; ?>
                                                                    <?php else: ?>
                                                                        <span>User</span>
                                                                    <?php endif; ?>
                                                                    sent on <?php echo e($message->created_at->format('d/m')); ?> at
                                                        ...
                                                        <?php if($transporter->messages->count() > 2): ?>
                                                    ...
                                                    <?php if($key == '0'): ?>
                                                        <?php if(Auth::user() && Auth::user()->id == $transporter->getTransporters->id): ?>
                                                            <form id="chat__form_<?php echo e($key); ?>"
                                                                action="<?php echo e(route('transporter.message.quote_send_message')); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <?php
                                                                ...
                                                                <input type="hidden" name="user_id"
                                                                    value="<?php echo e($quote->user_id); ?>">
                                                                <input type="hidden" name="user_quote_id"
                                                                    value="<?php echo e($transporter->user_quote_id); ?>">
    ...
    <div class="modal get_quote fade custom-slide" id="quote" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="main_form" method="post" action="<?php echo e(route('transporter.submit_offer')); ?>" class="bid_form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?php echo e($quote->image); ?>" class="d-block w-100" alt="..." />
                            </div>
                            <?php if($quote->image_1): ?>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset($quote->image_1)); ?>" class="d-block w-100" alt="..." />
                                </div>
                            <?php endif; ?>
    ...
    <div class="modal get_quote fade custom-slide" id="quoteEdit" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="editQuoteForm" action="<?php echo e(route('transporter.submit_offer')); ?>" method="POST"
                    class="bid_form">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="form-group">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('assets/web/js/rangeslider.js')); ?>"></script>
    <script type="text/javascript"
        src="https://maps.google.com/maps/api/js?key=<?php echo e(config('constants.google_map_key')); ?>&libraries=places"></script>
    ...
    <script>
        ...
        function share_edit_quote(id) {
            ...
            var quotes = <?php echo json_encode($quote, 15, 512) ?>;
        ...
        function removeToWatchlist(quoteId) {
            $.ajax({
                url: "<?php echo e(route('transporter.watchlist.remove')); ?>", // Replace with your route for adding to the watchlist
                type: 'POST',
                data: {
        ...
        function addToWatchlist(quoteId) {
            ...
            $.ajax({
                url: "<?php echo e(route('transporter.watchlist.store')); ?>", // Replace with your route for adding to the watchlist
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>', // CSRF token for security
                    quote_id: quoteId // Quote ID to be sent
    ...
    <script>
        $(document).ready(function() {
            var globalSiteUrl = '<?php echo $path = url('/'); ?>'
            var isMobile = '<?php echo e(isMobile()); ?>';
    ...
    <script>
        ...
        if (document.referrer) {
            ...
            window.location.href = "<?php echo e($previousUrl); ?>"; // Fallback if no history
        }
    }

    // Display the correct previous page name
    document.addEventListener("DOMContentLoaded", function () {
        let previousPath = "<?php echo e($previousPath); ?>";
        let pageName = "Find Jobs"; // Default

        if (previousPath === "<?php echo e($savedJobsPath); ?>") {
            pageName = " Saved Jobs";
        } else if (previousPath === "<?php echo e($watchlistPath); ?>") {
            pageName = " Watchlist";
        }
...
<?php echo $__env->make('layouts.transporter.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravelproject\transport\staging.transportanycar.com\resources\views/transporter/dashboard/job_infromation.blade.php ENDPATH**/ ?>